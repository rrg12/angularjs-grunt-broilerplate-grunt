 ...
 * *************************************************************/
angular.module('PMTViewer').controller('MapDetailCtrl', function ($scope, $rootScope, stateService, mapService, pmtMapService, config) {
    ...
    // sfunction to link activity list to activity module
    ...
    function showLocations() {
        if ($scope.activeDetail.location_ids) {
            var location_ids = $scope.activeDetail.location_ids.join(',');
            mapService.clearGeojson();
