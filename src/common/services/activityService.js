...
angular.module('PMTViewer').service('activityService', function ($q, $http, config, stateService, pmt, $state, $rootScope, partnerLinkService, pmtMapService) {
    ...
    activityService.processOverview = function (activityData) {
        ...
        _.each(activityData.taxonomies, function (taxonomy) {
            //sector category
    ...
    function processActivities() {
        var activityList = activityService.allActivities.slice(0, activityService.allActivities.length);
        var parentActivities = {};
        var childActivities = activityService.allActivities.slice(0, activityService.allActivities.length);
