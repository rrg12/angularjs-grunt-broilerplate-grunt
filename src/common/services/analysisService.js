...
angular.module('PMTViewer').service('analysisService', function ($rootScope, $http, $q, pmt) {
    ...
    analysisService.getStatsActivityByTaxonomy = function (taxonomy_id, data_group_ids, classification_ids, start_date, end_date, boundary_id, feature_id, record_limit) {
        var deferred = $q.defer();
        var options = {
    ...
    analysisService.getPartnerPivot = function (row_taxonomy_id, column_taxonomy_id, org_role_id, data_group_ids, classification_ids, start_date, end_date, boundary_id, feature_id) {
        var deferred = $q.defer();
        var options = {
